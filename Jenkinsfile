pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/cairlsr'                                   //<-----change this to your MiamiID!
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/miamioh-cairlsr/225-lab5-1.git'     //<-----change this to match this new repository!
        KUBECONFIG = credentials('cairlsr-225')                           //<-----change this to match your kubernetes credentials (MiamiID-225)! 
    }
